...
//---------------------------------------------------------------------
#define OUT_DIR         "Results/k218b_soot_20/"
//---------------------------------------------------------------------
...
//------------------------------------
#define MASS_PLANET 5.154e+25      // kg Planet's mass
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
#define RADIUS_PLANET 16628E+3     // m Planet's radius
#define ORBIT       0.222       // AU  Planet's semi-major axis, equivalent to around GJ 176, consider A_B=0.3
...
#define AIRM        32.0 /* Initial mean molecular mass of atmosphere, in atomic mass unit*/
...
/* Initial Heat Flux */
#define TINTSET	    60.0e+0		/* Internal Heat Temperature, low like Earth */
...
#define TPLIST      "Results/k218b_soot_20/NewTemperature.dat"
...
#define TTOP        300.0       /* Temperature at PTOP in K */
...
#define TMIDDLE     300.0       /* Tempeature at PMIDDLE */
#define PSTR        1.0E-1       /* Pressure at the top of troposphere (only used if inversion) */
#define TSTR        300.0       /* Temperature at PSTR */
#define PTROP       1.0E+0       /* Pressure at the bottom of troposphere */
#define TTROP       300.0       /* Temperature at PTROP */
#define PBOTTOM     2.0E+1       /* Pressure at the bottom of atmosphere */
