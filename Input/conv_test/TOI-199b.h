...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "TOI-199b.h"
//---------------------------------------------------------------------
//#define OUT_DIR         "Results/55cnce/standard_200_test_f03/IW-2/"
#define OUT_DIR         "Results/TOI-199b/"
...
//------------------------------------
//M_Planet = 8.6 M_E
#define MASS_PLANET 3.23e+26      // kg Planet's mass
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
//R_Planet = 1.95 R_E
#define RADIUS_PLANET 5.79e+07    // m Planet's radius
#define ORBIT      0.425      // AU  Planet's semi-major axis, equivalent to around Sun

/* Star spectrum */
#define STAR_SPEC   "Library/Star/HELIOS/TOI-199_spectra_converted.dat"
#define STAR_RADIUS 0.82 // Solar rad
#define STAR_TEMP   5255//     /* Star temperature at surface (old version at 1 AU) */
...
#define THETAANGLE  0.0		// Slant Path Angle in degrees: 60 for global average, 30 for hemispheric

/* HELIOS-consistent radiative transfer mode switch */
/* Choose ONE of the following options: */
#define DIRECT_BEAM_MODE 0    /* 0 = Pure diffuse mode (like HELIOS dir_beam=0, uses FADV) */
//#define DIRECT_BEAM_MODE 1    /* 1 = Pure direct beam mode (like HELIOS dir_beam=1, uses THETAANGLE) */
/* Note: DIRECT_BEAM_MODE 0 uses FADV and ignores THETAANGLE */
/*       DIRECT_BEAM_MODE 1 uses THETAANGLE and ignores FADV */
...
#define PBOTTOM     1000       /* Pressure at the bottom of atmosphere */
