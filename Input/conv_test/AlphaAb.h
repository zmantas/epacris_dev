...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "AlphaAb.h"
//---------------------------------------------------------------------
//#define OUT_DIR         "Results/55cnce/standard_200_test_f03/IW-2/"
#define OUT_DIR         "Results/AlphaAb/"
...
//------------------------------------
//M_Planet = 8.6 M_E
#define MASS_PLANET 7.3E+26      // kg Planet's mass
...
#define STAR_RADIUS 1.2175 // Solar rad
#define STAR_TEMP   5790//     /* Star temperature at surface (old version at 1 AU) */
