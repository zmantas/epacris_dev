...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "55cnce_comp5_f067.h"
//---------------------------------------------------------------------
//#define OUT_DIR         "Results/55cnce/standard_200_test_f03/IW-2/"
#define OUT_DIR         "Results/55cnce/helios_benchmark/55cnce_comp5_f067/"
...
//---------------------------------------------------------------------
#define COMMENTS        "helios_benchmark_55cnce_comp5_f067"
...
#define ELE_ABUN        "Input/elemental_abundance_files/conv_test.dat"
...
//------------------------------------
//M_Planet = 8.6 M_E
#define MASS_PLANET 5.134E+25      // kg Planet's mass
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
//R_Planet = 1.95 R_E
#define RADIUS_PLANET 12423450.0     // m Planet's radius
#define ORBIT       0.016       // AU  Planet's semi-major axis, equivalent to around Sun
...
#define FADV	    0.67     /* Advection factor: 0.25=uniformly distributed, 0.6667=no Advection */
...
/* Molecular Species */
#define SPECIES_LIST "Condition/SpeciesList/species_helios_comp5.dat"
//- CONVECTION -----------------------
...
#define Tol_RC_T    3.0e-0  /* convergence tolerance in temperature, in Kelvin */
...
#define Tol_FRATIO  1.0E-3  //convergence tolerance in unbalanced radiative flux per layer against layer radiance SIGMA*T^4
