...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "55cnce-guillot.h"
//---------------------------------------------------------------------
#define OUT_DIR         "Results/55cnce-iw4-test/"
...
//------------------------------------
//M_Planet = 5.712 M_E
#define MASS_PLANET 4.83E+25      // kg Planet's mass
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
//R_Planet = 2.194 R_E
#define RADIUS_PLANET 12182242.0     // m Planet's radius
#define ORBIT       0.0156       // AU  Planet's semi-major axis, equivalent to around Sun
...
#define TPLIST      "Results/55cnce-iw4-test/NewTemperature.dat"
