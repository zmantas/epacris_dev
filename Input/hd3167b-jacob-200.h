...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "hd3167b-jacob.h"
//---------------------------------------------------------------------
#define OUT_DIR         "Results/magmaplanet/hd3167b_IW/"
//---------------------------------------------------------------------
...
//------------------------------------
#define MASS_PLANET 3.0E+25      // kg Planet's mass
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
#define RADIUS_PLANET 1064E+4     // m Planet's radius
#define ORBIT       0.0146       // AU  Planet's semi-major axis, equivalent to around GJ 176

/* Star spectrum */
#define STAR_SPEC   "Library/Star/hd97658_0.txt"

/* Atmospheric Properties */
#define RefIdxType  0	/* Type of Refractive Index: 0=Air, 1=CO2, 2=He, 3=N2, 4=NH3, 5=CH4, 6=H2, 7=O2, 8=CO, 9=H2O */
#define AIRM        44.0 /* Initial mean molecular mass of atmosphere, in atomic mass unit*/
...
/* Initial Heat Flux */
#define TINTSET	    60.0e+0		/* Internal Heat Temperature */
...
#define TPLIST      "Results/magmaplanet/hd3167b_IW/NewTemperature.dat"
