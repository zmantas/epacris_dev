...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "l98-59b-jacob-1.h"
//---------------------------------------------------------------------
#define OUT_DIR         "Results/l98-59b/so2only-1-bar-1541/"
...
#define RT_FLUX_SOLVER  4   // 0 = Thomas Algorithm Bottom-Up on Eq sequence 1 (26,25,26,25,...,26,Bnd.Eq.)
                            ...
                            // 4 = PTRANS-I pentadiagonal solver, only one implemented!!!
...
//------------------------------------
#define MASS_PLANET 2.39e+24      // kg L98-59b
//R_Jupiter = 69,911E+3 m (= 10.973*R_Earth)
//R_Earth = 6371E+3 m
//------------------------------------
#define RADIUS_PLANET 5.42e+6     // m L98-59b
#define ORBIT       0.0382       // AU  Planet's semi-major axis, equivalent to around Sun

/* Star spectrum */
#define STAR_SPEC   "Library/Star/gj176_0.txt"

/* Atmospheric Properties */
#define RefIdxType  0	/* Type of Refractive Index: 0=Air, 1=CO2, 2=He, 3=N2, 4=NH3, 5=CH4, 6=H2, 7=O2, 8=CO, 9=H2O */
#define AIRM        64.0 /* Initial mean molecular mass of atmosphere, in atomic mass unit*/
...
/* Initial Heat Flux */
#define TINTSET	    1541.0		/* Internal Heat Temperature, Finso = 32000 W/m2, 1x Finso is 1541, 10x Finso is 1541 */
...
#define TPLIST      "Results/l98-59b/so2only-1-bar-1541/NewTemperature.dat"
//#define TPLIST      "Results/jupiter-valid1time-Guillot/NewTemperature.dat"

#define zbin        70            /*How many altitude bin?*/

#define PTOP        1.0E-8       /* Pressure at the top of atmosphere in bar */
#define TTOP        1000.0       /* Temperature at PTOP in K */
...
#define TMIDDLE     1000.0       /* Tempeature at PMIDDLE */
#define PSTR        1.0E-1       /* Pressure at the top of troposphere (only used if inversion) */
#define TSTR        1000.0       /* Temperature at PSTR */
#define PTROP       2.0E-1       /* Pressure at the bottom of troposphere */
#define TTROP       1000.0       /* Temperature at PTROP */
#define PBOTTOM     1.0E+0       /* Pressure at the bottom of atmosphere */
...
/* Reaction List */
#define REACTION_LIST "Condition/ReactionList/zone_general_CHONS.dat"
...
#define Tol_RC_R    1.0E-4  /* convergence tolerance in unbalanced radiative flux, per internal heat flux (net outgoing flux) */
...
#define NSP         112                 /*Number of species in the standard list*/
