...
//*************************************************************
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        //while (rcount<=NMAX_RC ) { 
            ...
            if (RTstepcount % 50 == 0) {  // Only print every 50 steps
            ...
            // Calculate sumisequil outside the print condition since it's needed for logic
            sumisequil = 0;  // Reset before summing
            for (j=zbin; j>=0; j--) {
