...
NAME = {'CH_4','C_2H_6','C_2H_2','CO','CO_2','NH_3','N_2','HCN','H_2O','H_2S'};
    
STD = [21,31,27,20,52,9,55,37,7,45];

COLOR = {'b','c','g',[0 0.4 0.6],[0.6 0.2 0],'r',[0 0.5 0],'m','k',[0.9 0.7 0.1]};
