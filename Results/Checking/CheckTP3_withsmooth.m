...
FILENAME1 = '../LHS3844b_Ultramafic_CO2_1/NewTemperature.dat';
FILENAME2 = '../LHS3844b_Ultramafic_CO2_1e-1/NewTemperature.dat';
FILENAME3 = '../LHS3844b_Ultramafic_CO2_1e-2/NewTemperature.dat';
...
semilogy(smooth(t1,9), p1, 'k', 'LineWidth', 2);
semilogy(smooth(t2,9), p2, 'b', 'LineWidth', 2);
semilogy(smooth(t3,9), p3, 'r', 'LineWidth', 2);
