...
//--------------------------------------------------------------------- 
#define IN_FILE_NAME    "jupiter-jacob.h"
//---------------------------------------------------------------------
//#define OUT_DIR         "Results/k218b-guillot/"
//#define OUT_DIR         "Results/k218b-toon/"
//#define OUT_DIR         "Results/k218b-time-50x/"
//#define OUT_DIR         "Results/jupiter-time/"
//#define OUT_DIR         "Results/jupiter-jacob/"
#define OUT_DIR         "Results/jupiter-jacob-Toon/"
//---------------------------------------------------------------------
#define COMMENTS        "RC-loop"
...
#define TWO_STR_SOLVER  0   // 0 = 2stream as in Toon+1989 (by Renyu Hu)
...
#define CONVEC_ADJUST   1   // 0 = initial dry adiabat (by Renyu Hu)
                            // 1 = 2022 update by Markus Scheucher - see ms_conv_funcs.c
//MS end.
//--------------------------------------------------------------------- 
//--------------------------------------------------------------------- 
/* Initial Concentration Setting */
#define IMODE       0   /* 1: Import from SPECIES_LIST; 
...
#define NMAX_RT     1.0e+2  /* Maximum Radiative Transfer Iterations */
#define NRT_RC      1.0E+2  /*RT steps between Convective adjustments after initial RT equilibrium */
...
//------------------------------------
//M_Planet = 5.712 M_E
#define MASS_PLANET 1.8982E+27       // kg Planet's mass
...
#define AIRM        2.0 /* Initial mean molecular mass of atmosphere, in atomic mass unit*/
...
#define THETAANGLE  60.000		// Slant Path Angle in degrees: 60 for global average, 30 for hemispheric 
#define PSURFAB	    1.0000		/* Planet Surface Reflectivity */
...
//#define TPLIST      "Results/k218b-guillot/NewTemperature.dat"
...
#define TTOP        750.0        /* Temperature at PTOP in K */
...
#define DT_MAX      3.0e-2     /* maximum dT change in implicit Euler stepping of radiative balance */
#define RJACOB_TEMPVAR 1.0e-2  /* temperature variation in calculating the Jacobian */
...
#define TIDELOCK    1 //GREY ONLY   	/* If the planet is tidelly locked */
#define PAB         0.3 //GREY ONLY	/* Planet Bond Albedo */
