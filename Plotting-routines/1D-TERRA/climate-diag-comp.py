...
simu = [
        ...
        'trappist-1e-g-icons',
        'trappist-1e-lemar00',
        'trappist-1e-lemar1e-2',
        'trappist-1e-lemar01',
        'trappist-1e-lemar2e-1', #10
        'trappist-1e-lemar4e-1',
        'trappist-1e-lemar1',
        'trappist-1e-nit0.1-1e-2',
        'trappist-1e-nit10-1e-2',
        'trappist-1e-nit0.1-1e-1',
        'trappist-1e-nit10-1e-1',
        'trappist-1e-lemar1e-2-i2',
        'trappist-1e-lemar01-i2',
        'trappist-1e-lemar2e-1-surf400',
        'trappist-1e-lemar2e-1-i2',   #20
        'gj176-1e-2',
        'gj176-1e-1',
        'gj176-2e-1',
        'trappist-1e-nit0.1-1e-2-i2',
        'trappist-1e-nit10-1e-2-i2',
        'trappist-1e-nit0.1-1e-1-i2',
        'trappist-1e-nit10-1e-1-i2',
        'gj176-1e-2-i2',
        'gj176-1e-1-i2',
        'gj176-2e-1-i2',   #30
        'trappist-1e-lemar1e-2-i3',
        'trappist-1e-lemar01-i3',
        'lemar01-i4',
        'lemar1-i2',
        'lemar2e-1-i3',
        'lemar4e-1-i2',
        ...
        'dtvector-iup400',
        'lemar1-i2-iso200',
        'lemar1-i2-iso200-limitdt',
        'lemar1-i2-iso200-dtevo',
        'lemar1-i2-iso200-dtevo-limitdt', #50
        'lemar1-i2-dtv280-dtevo',
        'lemar4e-1-i2-dtv280',
        'lemar4e-1-i2-dtv280-dtevo',
        'gj176-2e-1-i2-dtevo',   
        'gj176-2e-1-i2-dtv280-dtevo',
        't1e-4e-1-i2-evo2-00',
        't1e-2e-1-i4-evo1-42',
        't1e-2e-1-i5-evo0-32-iter20-cont',
        't1e-nit01-1e-1-i2-evo0-01-iter20-cont',
        't1e-nit01-1e-1-i3-evo1-22-iter20', #60
        't1e-1-i3-evo1-01-iter20Tad-cont',
        't1e-1-i4-evo0-02-cont',
        't1e-1-i4-evo1-32-cont',
        ]
...
selection = [4,10,20,41,57,58]
selection = [3,9,18,32,33]
#selection = [15,26,59,60]
selection = [6,12,48,61,62]
#outfile = 'REDFOX-1step-flux-comparison' #Name of outfile
#outfile = 'Venus-Cool' #Name of outfile
outfile = 'Trappist-1e-1-i4' #Name of outfile
#outfile = 'Trappist-nit01-1e-1-i3' #Name of outfile
