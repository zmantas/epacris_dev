...
mselection =['T','H2O','OH','CH4','N2O','O3','HNO3','NO','NO2'] #Specify what to plot. *** ALL=[-1] ***
...
plotcolumns = 0 #1:plot column densities. (update 2020: AUTO prints it to stdout, but doesn't plot) 
plotprofiles = 1 #1:Plot profiles
plotcols_profiles = 3 #number of columns of plots when plptting profiles
