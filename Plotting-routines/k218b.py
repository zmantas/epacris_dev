...
outfile = 'RC_valid-K218b' #Name of outfile
...
#        'jupiter-guillot',
        ...
        'k218b-valid1-Guillot',
        'k218b-valid2-Texp8',
        'k218b-valid3-lowTiso',
        'k218b-valid4-highTiso',
#        'k218b-valid5-1DTERRA',
        'k218b-valid6-Tiso2k',

        'k218b-valid1time-Guillot',
        'k218b-valid2time-Texp8',
        'k218b-valid3time-lowTiso',
        'k218b-valid4time-highTiso',
#        'k218b-valid5time-1DTERRA',
        'k218b-valid6time-Tiso2k',
        
        'k218b-guillot',
        'INPUTS/gen_e8',
        'INPUTS/Tiso200',
        'INPUTS/Tiso1000',
#        'INPUTS/K218b-1DTERRA',
        'INPUTS/Tiso2000',
