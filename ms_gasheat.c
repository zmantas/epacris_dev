...
double CO2Heat(double T)
{
	...
	if (T<298.0 & T>=200.0) cp = CPinterp(T,cp200,cp298); 
	if (T<200.0 & T>=100.0) cp = CPinterp(T,cp100,cp200); 
	if (T<100.0) cp = cp100; 
        else
        {    
            if (T>6000.0) {
...
double H2OHeat(double T)
{
    ...
    if (T<500.0 & T>=400.0) cp = CPinterp(T,cp400,cp500); 
    if (T<400.0 & T>=300.0) cp = CPinterp(T,cp300,cp400); 
    if (T<300.0 & T>=200.0) cp = CPinterp(T,cp200,cp300); 
    if (T<200.0 & T>=100.0) cp = CPinterp(T,cp100,cp200); 
    if (T<100.0) cp = cp100; 
    else
    {    
